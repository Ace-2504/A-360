...
mongoose.connect(dbUrl).then(() => {
    console.log("Connected to database at:", mongoose.connection.host); // This tells you WHERE
    console.log("Database Name:", mongoose.connection.name); // This tells you the NAME
});
